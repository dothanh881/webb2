  ...
  INSERT INTO `product` (`item_id`, `category_id`, `item_name`, `item_quantity`, `item_price`, `item_color`, `item_image`, `item_discription`, `item_status`, `item_rom`, `item_ram`, `size_screen`, `created_at`, `updated_at`)
  VALUES
  (1, 1, 'iPhone 15 Pro Max', 10, 1452, 'Blue', './assets/products/img1.png', 'iPhone 15 Pro Max is the most advanced iPhone with the largest screen, best battery life, strongest configuration and super durable, super light aerospace-standard Titanium frame design. iPhone 15 Pro Max possesses Apple most outstanding features. Accordingly, users will experience a high-end iPhone with "huge" performance with A17 Pro chip, titanium frame, upgraded zoom capabilities, new action buttons,...', 1, 512, 8, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 1, 'iPhone 15 Pro Max', 10, 1452, 'Black','./assets/products/img2.png', 'iPhone 15 Pro Max is the most advanced iPhone with the largest screen, best battery life, strongest configuration and super durable, super light aerospace-standard Titanium frame design. iPhone 15 Pro Max possesses Apple most outstanding features. Accordingly, users will experience a high-end iPhone with "huge" performance with A17 Pro chip, titanium frame, upgraded zoom capabilities, new action buttons,...', 1, 512, 8, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (3, 1, 'iPhone 14 Plus', 10, 1129, 'Purple', './assets/products/img3.png', 'The appeal of the new generation iPhone 2022 with a large screen, the best battery ever, impressive night photography and a series of top-notch technologies, the iPhone 14 Plus brings users into advanced mobile experiences. Advanced, ready for an active, smart and convenient life', 1, 256, 6, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (4, 1,  'iPhone 14 Plus', 10, 1129, 'Yellow', './assets/products/img4.png', 'The appeal of the new generation iPhone 2022 with a large screen, the best battery ever, impressive night photography and a series of top-notch technologies, the iPhone 14 Plus brings users into advanced mobile experiences. Advanced, ready for an active, smart and convenient life', 1, 256, 6, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (5, 1,  'iPhone 13 Pro Max', 10, 1048, 'White', './assets/products/img5.png', 'iPhone 13 Pro Max has the best dual camera system ever, the fastest Apple A15 processor in the smartphone world and extremely long battery life, ready to accompany you all day long.', 1, 512, 6, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (6, 1,  'iPhone 12 Pro Max', 10, 484, 'Yellow', './assets/products/img6.png', 'In the last months of 2020, Apple officially introduced to users as well as iFans the new generation of iPhone 12 series with a series of breakthrough features, completely transformed design, powerful performance and one of That is the iPhone 12 Pro Max 128 GB', 1, 128, 6, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (7, 2,  'Samsung Galaxy S24 Ultra', 10, 1089, 'Blue', './assets/products/img7.png', 'Samsung Galaxy S24 Ultra is the smartest Galaxy phone ever with connection power, creative power and entertainment power all powered by Galaxy AI artificial intelligence. Completely new design from the classy Titanium frame, super camera with resolution up to 200MP and Snapdragon 8 Gen 3 for Galaxy processor will bring an unprecedented exciting experience for you', 1, 512, 12, 6.8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (8, 2, 'Samsung Galaxy S22 Ultra 5G', 10, 605, 'Black', './assets/products/img8.png', 'Samsung Galaxy S24 Ultra is the smartest Galaxy phone ever with connection power, creative power and entertainment power all powered by Galaxy AI artificial intelligence. Completely new design from the classy Titanium frame, super camera with resolution up to 200MP and Snapdragon 8 Gen 3 for Galaxy processor will bring an unprecedented exciting experience for you', 1, 256, 12, 6.8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (9, 2, 'Samsung Galaxy Z Fold5 5G', 10, 1493, 'Blue', './assets/products/img9.png', 'Joining Samsung Galaxy Z Flip 5 flexibly, you will experience a series of exciting breakthrough technologies and a completely new unique design. Where you can freely explore and confidently express your personality. The compactness, fit and fashion of the Z Flip 5 also help you stand out and be ready to "take on" all your favorite styles', 1, 512, 12, 7.6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (10, 2,  'Samsung Galaxy S23 Ultra', 10, 1129, 'Green', './assets/products/img10.png', 'Proud to be the first Galaxy phone to possess a superb 200MP sensor, the Samsung Galaxy S23 Ultra takes users into a world of cutting-edge photography. The power is also explosive with the most powerful Snapdragon processor for revolutionary gaming performance. All wrapped up in a premium and sustainable design for now and the future.', 1, 512, 12, 6.8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (11, 2,  'Samsung Galaxy S23 FE', 10, 524, 'Purple', './assets/products/img11.png', 'The Galaxy S23 FE 5G is the best Galaxy FE device Samsung has ever launched. Equipped with premium features from design to outstanding performance, an incredible night camera system. All combine to bring the perfect experience for work and entertainment', 1, 512, 8, 6.4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (12, 2,  'Samsung Galaxy A14', 10, 201, 'Silver', './assets/products/img12.png', 'Adding color and experience to your life, Samsung introduces the cheap Galaxy A14 4G with a series of new improvements. Everything is harmoniously combined from youthful design, 50MP camera system, sharp screen to super large battery, creating an attractive phone with many great advantages for young people', 1, 128, 4, 6.6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (13, 2,  'Samsung Galaxy M54', 10, 1089, 'Silver', './assets/products/img13.png', 'Following the success of the Galaxy M53 5G, Samsung continues to launch the Samsung Galaxy M54 5G phone model. This launch, Samsung has upgraded performance, battery capacity and improved design to help bring the best product to you.', 1, 256, 8, 6.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
  ...
  -- dumping data for table `cart`
   ...
   alter table `product` MODIFY item_status int not null DEFAULT 0;
